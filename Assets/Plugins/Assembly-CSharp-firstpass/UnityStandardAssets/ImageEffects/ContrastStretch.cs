...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class ContrastStretch : MonoBehaviour
	{
		...
		protected Material materialLum
		{
			get
			{
				if ((Object)(object)m_materialLum == null)
				{
					m_materialLum = new Material(shaderLum);
					((Object)(object)m_materialLum).hideFlags = HideFlags.HideAndDontSave;
				}
		...
		protected Material materialReduce
		{
			get
			{
				if ((Object)(object)m_materialReduce == null)
				{
					m_materialReduce = new Material(shaderReduce);
					((Object)(object)m_materialReduce).hideFlags = HideFlags.HideAndDontSave;
				}
		...
		protected Material materialAdapt
		{
			get
			{
				if ((Object)(object)m_materialAdapt == null)
				{
					m_materialAdapt = new Material(shaderAdapt);
					((Object)(object)m_materialAdapt).hideFlags = HideFlags.HideAndDontSave;
				}
		...
		protected Material materialApply
		{
			get
			{
				if ((Object)(object)m_materialApply == null)
				{
					m_materialApply = new Material(shaderApply);
					((Object)(object)m_materialApply).hideFlags = HideFlags.HideAndDontSave;
				}

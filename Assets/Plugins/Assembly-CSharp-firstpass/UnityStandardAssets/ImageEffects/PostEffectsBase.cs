...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class PostEffectsBase : MonoBehaviour
	{
		...
		protected Material CheckShaderAndCreateMaterial(Shader s, Material m2Create)
		{
			...
			if (s.isSupported && (bool)(UnityEngine.Object)(object)m2Create && m2Create.shader == s)
			{
				return m2Create;
			}
			if (!s.isSupported)
			...
			((UnityEngine.Object)(object)m2Create).hideFlags = HideFlags.DontSave;
			return m2Create;
		}
		...
		protected Material CreateMaterial(Shader s, Material m2Create)
		{
			...
			if ((bool)(UnityEngine.Object)(object)m2Create && m2Create.shader == s && s.isSupported)
			{
				return m2Create;
			}
			if (!s.isSupported)

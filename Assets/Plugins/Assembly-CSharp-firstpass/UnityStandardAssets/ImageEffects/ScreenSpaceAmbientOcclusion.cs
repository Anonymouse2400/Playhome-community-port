...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class ScreenSpaceAmbientOcclusion : MonoBehaviour
	{
		...
		private static Material CreateMaterial(Shader shader)
		{
			...
			((UnityEngine.Object)(object)material).hideFlags = HideFlags.HideAndDontSave;
			return material;
		}

		private static void DestroyMaterial(Material mat)
		{
			if ((bool)(UnityEngine.Object)(object)mat)
			{
				UnityEngine.Object.DestroyImmediate((UnityEngine.Object)(object)mat);
				mat = null;
			}
		}
		...
		private void Start()
		{
			...
			CreateMaterials();
			if (!(UnityEngine.Object)(object)m_SSAOMaterial || m_SSAOMaterial.passCount != 5)
			{
				m_Supported = false;
				base.enabled = false;
			}
		...
		{
			if (!(UnityEngine.Object)(object)m_SSAOMaterial && m_SSAOShader.isSupported)
			{

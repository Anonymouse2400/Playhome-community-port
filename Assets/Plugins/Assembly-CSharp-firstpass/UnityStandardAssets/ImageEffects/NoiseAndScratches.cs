...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class NoiseAndScratches : MonoBehaviour
	{
		...
		protected Material material
		{
			get
			{
				if ((Object)(object)m_MaterialRGB == null)
				{
					m_MaterialRGB = new Material(shaderRGB);
					((Object)(object)m_MaterialRGB).hideFlags = HideFlags.HideAndDontSave;
				}
				if ((Object)(object)m_MaterialYUV == null && !rgbFallback)
				{
					m_MaterialYUV = new Material(shaderYUV);
					((Object)(object)m_MaterialYUV).hideFlags = HideFlags.HideAndDontSave;
				}
		...
		{
			if ((bool)(Object)(object)m_MaterialRGB)
			{
				Object.DestroyImmediate((Object)(object)m_MaterialRGB);
			}
			if ((bool)(Object)(object)m_MaterialYUV)
			{

...
namespace UnityStandardAssets.CinematicEffects
{
	...
	public class ScreenSpaceReflection : MonoBehaviour
	{
		...
		{
			if ((UnityEngine.Object)(object)material == null || Camera.current.actualRenderingPath != RenderingPath.DeferredShading)
			{
				return;
			}
			...
			Vector3 vector2 = ((!float.IsPositiveInfinity(camera_.farClipPlane)) ? new Vector3(camera_.nearClipPlane * camera_.farClipPlane, camera_.nearClipPlane - camera_.farClipPlane, camera_.farClipPlane) : new Vector3(camera_.nearClipPlane, -1f, 1f));
			...
			material.SetVector("_ProjInfo", vector);
			material.SetVector("_CameraClipInfo", vector2);

...
public class AlloyDeferredRendererPlus : MonoBehaviour
{
	...
	public void Refresh()
	{
		bool flag = SkinSettings.Enabled;
		bool flag2 = TransmissionSettings.Enabled || flag;
		if (m_isTransmissionEnabled == flag2 && m_isScatteringEnabled == flag)
		{
			RefreshProperties();
		}
		else
	...
	private void ResetCommandBuffers()
	{
		...
		DestroyCommandBuffers();
		if ((m_isTransmissionEnabled || m_isScatteringEnabled) && m_camera != null && DeferredTransmissionBlit != null)
		{
			int num = Shader.PropertyToID("_DeferredPlusBuffer");
			m_deferredTransmissionBlitMaterial = new Material(DeferredTransmissionBlit);
			((UnityEngine.Object)(object)m_deferredTransmissionBlitMaterial).hideFlags = HideFlags.HideAndDontSave;
			...
			else if (DeferredBlurredNormals != null)
			{
				...
				((UnityEngine.Object)(object)m_deferredBlurredNormalsMaterial).hideFlags = HideFlags.HideAndDontSave;
	...
	private void DestroyCommandBuffers()
	{
		...
		if ((UnityEngine.Object)(object)m_deferredTransmissionBlitMaterial != null)
		{
			UnityEngine.Object.DestroyImmediate((UnityEngine.Object)(object)m_deferredTransmissionBlitMaterial);
		}
		if ((UnityEngine.Object)(object)m_deferredBlurredNormalsMaterial != null)
		{
			UnityEngine.Object.DestroyImmediate((UnityEngine.Object)(object)m_deferredBlurredNormalsMaterial);
		}

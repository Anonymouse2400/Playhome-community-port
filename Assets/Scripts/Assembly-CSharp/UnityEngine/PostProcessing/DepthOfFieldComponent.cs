...
namespace UnityEngine.PostProcessing
{
	public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
	{
		...
		public override bool active
		{
			get
			{
				return base.model.enabled && SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf) && SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.RHalf) && !context.interrupted;
			}
		}
		...
		public void Prepare(RenderTexture source, Material uberMaterial, bool antialiasCoC)
		{
			...
			else
			{
				...
				material.SetFloat(Uniforms._HistoryWeight, (!flag) ? 0.5f : 0f);
